...
@SQLDelete(sql = "update t_course_category set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
@SQLDeleteAll(sql = "update t_course_category set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
