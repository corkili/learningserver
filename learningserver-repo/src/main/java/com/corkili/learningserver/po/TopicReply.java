...
@SQLDelete(sql = "update t_topic_reply set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
@SQLDeleteAll(sql = "update t_topic_reply set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
...
@ToString
@EqualsAndHashCode
public class TopicReply implements PersistObject {
