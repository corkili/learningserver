...
@Entity
@Table(name = "t_scorm_record")
@SQLDelete(sql = "update t_scorm_record set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
@SQLDeleteAll(sql = "update t_scorm_record set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
...
@ToString
@EqualsAndHashCode
public class ScormRecord implements PersistObject {
    ...
    @Column(name = "last_item", nullable = false, length = 2000)
    @NotBlank
