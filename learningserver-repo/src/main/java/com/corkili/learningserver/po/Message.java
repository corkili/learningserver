...
@SQLDelete(sql = "update t_message set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
@SQLDeleteAll(sql = "update t_message set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
...
@ToString
@EqualsAndHashCode
public class Message implements PersistObject {
