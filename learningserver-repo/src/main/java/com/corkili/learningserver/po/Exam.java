...
@Entity
@Table(name = "t_exam")
@SQLDelete(sql = "update t_exam set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
@SQLDeleteAll(sql = "update t_exam set " + POConstant.KEY_DELETED + " = " + POConstant.DELETED + " where id = ?")
...
@ToString
@EqualsAndHashCode
public class Exam implements PersistObject {
